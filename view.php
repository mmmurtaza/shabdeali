...
<body>
    ...
    <div class="container-xl" style="margin: 0;">
        ...
        <!-- Pagination -->
        <div class="row d-print-none visually-hidden">
            <div class="col my-3 d-flex justify-content-center">

                <div class="d-flex justify-content-center align-items-center mt-3">
                  <a href="edit.php?id=<?php echo $id-1 ?>" class="btn btn-outline-primary btn-lg me-2" id="prevBtn"> < </a>
                  <input type="text" class="form-control form-control-lg text-center border-primary text-primary" 
                         id="pageInput" style="width: 70px;" value="<?php echo $id ?>" >
                  <a href="edit.php?id=<?php echo $id+1 ?>" class="btn btn-outline-primary btn-lg ms-2" id="nextBtn"> > </a>
                </div>
        ...
        <div class="row">
            <!-- side part form -->
            <div class="col-md-6 col-sm-12 d-print-none visually-hidden">
