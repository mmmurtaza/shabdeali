...
$sql = "SELECT * FROM `nazamo` where qafiya is null or qafiya = '' ORDER BY Id DESC limit $page, 1";
echo $sql;
        ...
        <div class="row d-print-none">
            <div class="col my-3 d-flex justify-content-center">
                ...
                <div class="d-flex justify-content-center align-items-center mt-3">
                  <a href="edit2.php?page=<?php echo $page-1 ?>" class="btn btn-outline-primary btn-lg me-2" id="prevBtn"> < </a>
                  ...
                  <a href="edit2.php?page=<?php echo $page+1 ?>" class="btn btn-outline-primary btn-lg ms-2" id="nextBtn"> > </a>
                </div>
